...
const Index = () => {
  ...
  useEffect(() => {
    ...
    return subscriber; // unsubscribe on
  }, []);
          ...
          <ThemedView style={styles.subContainer}>
            ...
            >
              ...
              <ThemedText style={styles.infoText} type="default">
                ...
                easy-to-use mobile app that allows Kenyans to buy Worldcoin
                (WLD) directly from their phones.{"\n"}- With simple payment
                methods like M-Pesa, you can quickly and safely purchase
                Worldcoin and manage your digital assets.{"\n"}- The app
                features fast transactions, real-time updates, and a
                user-friendly interface designed for both beginners and
                experienced crypto enthusiasts.
                {"\n"}- Whether you're new to cryptocurrency or an active
                trader, Coinance provides a seamless and reliable platform to
                buy Worldcoin in Kenya. {"\n"}- By accessing and using this app,
              ...
              <ThemedText style={styles.infoText}>
                ...
                personal data.
                {"\n"}- Our privacy policy outlines the types of data we collect
                and how we use it. {"\n"}
              </ThemedText>
              <ThemedText style={{ fontSize: 13 }} type="defaultSemiBold">
              ...
              <ThemedText style={styles.infoText}>
                ...
                {"\n"}- We still make no guarantees regarding the app's
              ...
              <ThemedText style={styles.infoText}>
                ...
                with the laws of your country of residence.{"\n"}
              </ThemedText>
              <ThemedText style={{ fontSize: 13 }} type="defaultSemiBold">
                7. Termination
              </ThemedText>
              ...
              <ThemedText style={[styles.infoText, { marginBottom: 40 }]}>
                - We reserve the right to terminate user accounts that violate
